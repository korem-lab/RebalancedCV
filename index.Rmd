...
RebalancedCV contains the following three classes: [__RebalancedLeaveOneOut__](RebalancedLeaveOneOut.html), [__RebalancedKFold__](RebalancedKFold.html), [__RebalancedLeavePOut__](RebalancedLeavePOut.html), [__RebalancedLeaveOneOutRegression__](RebalancedLeaveOneOutRegression.html), and [__MulticlassRebalancedLeaveOneOut.html__](MulticlassRebalancedLeaveOneOut.html). These are implementations for `Leave One Out`, `Stratified K-Fold`, and `Leave P Out` cross-validation with sub-sampling within training sets to ensure that, for any cross-validation scheme, the class balances across all training folds are identical.
...
```python
from rebalancedcv import RebalancedLeaveOneOut, RebalancedKFold, RebalancedLeavePOut, RebalancedLeaveOneOutRegression, MulticlassRebalancedLeaveOneOut
```
<br>
